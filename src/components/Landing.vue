<template>
    ...
    <main id="main">
        ...
        <div class="container">
            ...
            <div class="col-lg-6">
                <p>
                Acontinuacion describiremos el valor que ofrecemos a nuestros clientes.
                </p>
                <ul>
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch ">
                <div class="member">
                <div class="member-img">
                    <img src="@/assets/img/team/john.jpeg" class="img-fluid" alt="">
                    <div class="social">
                    <!-- <a href=""><i class="bi bi-twitter"></i></a> -->
...
export default {
    data() {
        return {
            url: 'https://salty-retreat-53300.herokuapp.com',
			producto: [],
            categorias: []			      
        }
    },
